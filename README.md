...
*   [nikolasrieble/opencode-config](https://github.com/nikolasrieble/opencode-config) - Opinionated company-wide OpenCode configuration with agents for Jira, Confluence, and security reviews
